...
# ------------------------------------------------
data_dir = r"S:\viirs\VNP14IMG_002-20260104_124029"
out_dir = r"S:\viirs\fitgrid_2022_VIIRS_daily_gridded_0.021_nc"
...
# ------------------------------------------------
# TROPOMI grid start (for alignment)
# ------------------------------------------------
tr_lat_start = 26.31225586
tr_lon_start = 80.01342773
...
# Create bins aligned with TROPOMI
lat_bins = np.arange(tr_lat_start - res / 2, lat_max + res, res)
lon_bins = np.arange(tr_lon_start - res / 2, lon_max + res, res)
